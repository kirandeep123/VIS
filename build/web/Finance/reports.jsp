...
<TABLE WIDTH=1024 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	<TR>
		<TD COLSPAN=2>
			<map name="FPMap1">
			<area href="Finance/home.jsp" shape="rect" coords="506, 188, 585, 214">
	...
	<TR>
		...
		<TD background="images/024.jpg" width="752">
				<div align="center">
					<form method="POST" action="reptemp.jsp">
			<table border="0" width="76%" id="table1" cellspacing="0" cellpadding="0" >
				<tr>
					<td>&nbsp;</td>
					<td>
					<p align="center"><b><font face="Verdana">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Choose one option</font></b></td>
					<td colspan="2">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="2">&nbsp;</td>
				...
				<tr>
					...
					<input type=radio name="r1" value="tdyfin" checked>&nbsp; 
					Today's Finance Applications</font></td>
					<td width="4%">&nbsp;</td>
					<td width="6%">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="47%">
					<font face="Verdana">
					<input type=radio name="r1" value="tdyalrt" >&nbsp; Alert 
					Messages Send Today</font></td>
					<td width="4%">
				...
				<tr>
					...
					<input type=radio name="r1" value="allfin" >&nbsp; All 
					Finance Applications</font></td>
					<td width="4%">&nbsp;</td>
				</tr>
				<tr>
					<td width="20%">&nbsp;</td>
				...
				<tr>
					...
					<td width="47%">
					<font face="Verdana">
					<input type=radio name="r1" value="allalrt" >&nbsp; All 
					Alert Messages Send</font></td>
					<td width="4%">&nbsp;</td>
					<td width="6%">&nbsp;</td>
				</tr>
				<tr>
