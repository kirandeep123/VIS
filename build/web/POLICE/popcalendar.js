...
//
//  SAMPLE TAG: <img src="../includes/calendar/calendar.gif" id="imgDelivery_date" onclick="popUpCalendar(this, txtDelivery_Date, 'dd/mm/yyyy');" align="absMiddle" name="imgDelivery_date" />
	...
	function popUpCalendar(ctl,	ctl2, format) {
		...
		if (bPageLoaded)
		{
			if ( crossobj.visibility ==	"hidden" ) {
				...
				crossobj.left =	(fixedX==-1 ? ctl.offsetLeft + leftpos : fixedX) * 0.85
