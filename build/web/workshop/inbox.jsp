...
<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0 width="753"  height="458" id="table2">
	...
	<tr>
		<TD height="418" width="753">
			<div style="position: absolute; top: 326px; left: 216px; width: 802px; height: 180px; z-index: 1">
						<table width="705" height="164" border="0" id="table8">
							...
							<tr>
								...
								<table width="796" height="107" border="0" align="center" id="table9">
									<tr>
							...
							String ss1=(String)session.getAttribute("wid1");							Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
int i=0;
							Connection con=DriverManager.getConnection("jdbc:odbc:vis");

							Statement st=con.createStatement();
							
							ResultSet rs=st.executeQuery("Select * from workshopmail");
