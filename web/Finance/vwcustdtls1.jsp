...
<TABLE WIDTH=1024 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
		...
		<TD background="images/024.jpg" width="752"><form name="f1" method="POST" action="custdetails.jsp" onsubmit="return aa1();"/>
			<table border="0" width="76%" id="table1" cellspacing="0" cellpadding="0" >
				...
				<tr>
					...
					<td width="85%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
		<font face="Verdana"><b>ENTER&nbsp; CUSTOMER ID</b> </font>:&nbsp;&nbsp;&nbsp;
