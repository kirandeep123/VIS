...
<table id="Table_01" width="1024" height="768" border="0" cellpadding="0" cellspacing="0" background=bc.jpg>
	...
	<tr>
		<td width="229" rowspan="4" align="center">
			<map name="FPMap0">
			...
			<font size="4">
			<img src="images/POLICE_02.gif" width="229" height="564" alt="" usemap="#FPMap0" border="0"></font></td>
	...
	<tr>
		<td width="795" align="center">
			<font size="4">&nbsp;<%@ page import="java.sql.*"%>
...
session.setAttribute("newppass",b);
							...
							ResultSet rst=stt.executeQuery("Select * from login where pass='"+oldpass+"' ");
							if(rst.next())
							{
							response.sendRedirect("pcver.jsp");
							}
							else
							out.println("Password Cannot Be Changed...You Entered Wrong Password");
