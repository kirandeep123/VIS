...
<table id="Table_01" width="1024" height="768" border="0" cellpadding="0" cellspacing="0" background=bc.jpg>
	...
	<tr>
		...
		<td width="795">
						...
						<table width="719" height="164" border="0" id="table8">
							
						
							<tr>
										<form method="POST" action="firacknow.jsp">
							
								<td height="23" bgcolor="#5594d0">
								<p align="center"><b><span class="style38">
								FIR REPLY BOX</span></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp; </td>
							</tr>
							<tr>
								...
								<table width="720" height="107" border="0" align="center" id="table9">
									<tr>
...
int i=0;
							...
							ResultSet rs=st.executeQuery("Select * from firregister where status='NAR'");
							...
							%>
									...
									<tr>
										...
										<td colspan="3" align="center">&nbsp;<p>
											<input type="submit" value="    REPLY TO CUSTOMER   " name="B1"></form>&nbsp;</p></td>
										<td>&nbsp;</td>
									</tr>
									</table>
								</td>
