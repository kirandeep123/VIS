		...
		<TD ROWSPAN=2 background="images/023.jpg" width="747">
			...
			<table border="0" width="76%" id="table1" cellspacing="0" cellpadding="0" >
				<tr>
					...
					<td bgcolor="#800000">
					<p align="center"><b><font face="Verdana" color="#FFFFFF">Choose one option</font></b></td>
				...
				<tr>
					...
					<input type=radio name="r1" value="req" checked> 
					All&nbsp; Requests</font></td>
					<td width="4%">&nbsp;</td>
					<td width="4%">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="47%">
					<font face="Verdana">
					<input type=radio name="r1" value="comp" > All&nbsp; 
					Complaints</font></td>
					<td width="4%">
				...
				<tr>
					...
					<td width="51%" colspan="2" align="center" bgcolor="#800000">
					&nbsp;</td>
