...
function validate1()
{
	document.frm.action="renwlconfirm.jsp";
	document.frm.submit();
}

function validate2()
{
	document.frm.action="reqrnwl.jsp";
	document.frm.submit();
}
...
PreparedStatement st=con.prepareStatement("Select * from rtoreqst where type=? and date=?");
       ...
       st.setString(1,s3); st.setString(2,d5); 
							...
							ResultSet rs=st.executeQuery(); int k=0; String asd=null;
				...
				out.println(asd1);
					...
					<p>&nbsp;</p>
						...
						out.println("No Entry Found");
							...
							String s8=request.getParameter("sno");
                         ...
                         String a="Renewal Notice";
                         String b="Your Registration renewal is on 27-Sep-09";
                          String c=d5;
                          String d=d6;
                          String e="NOT READ";
                          String f="ash"; String sd2=asd; 
							...
							PreparedStatement stmt=con.prepareStatement("insert into usermail values(?,?,?,?,?,?,?)");
...
stmt.executeUpdate();
					...
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>
							<p>&nbsp;
					<input type="submit" value="Send Mail" name="B1" onClick="validate1();">&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="submit" value="Next" name="B2" onClick="validate2();" ></p>
					<p>&nbsp;</p>
				</form>
&nbsp;</TD>
	</TR>
