	...
	<TR>
		...
		<%
				...
				String x4=(String)session.getAttribute("cid1");
				 ...
				 String ab=request.getParameter("sno1");
				 session.setAttribute("FIR",ab);
				 
				String qry="Select * from firregister where firid="+ab;
...
if(rs91.next())
{
 ...
 z7=rs91.getString(14);
 if(z7.equals("NAR") | z7.equals("NR"))
 {
 	%>	<center><b>
		<table border="0" width="100%" id="table1">
			<tr>
				<td>
				<p align="center"><b><a href="firstatus.jsp">BACK</a></b></td>
			</tr>
		</table>
		&nbsp;<% out.println("Sorry Your  FIR Is Under Process....");
 
	}
  else
  {

response.sendRedirect("frfinal.jsp");
