...
<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0 width="1005" background =back1.jpg>
	<TR>
		<TD COLSPAN=2>
	...
	<TR>
		...
		<TD width="802" height="570">
						...
						<table width="719" height="164" border="0" id="table4">
							<tr>
							
								
										<form method="POST" action="firfinalstatus.jsp">
							
								<td height="23" bgcolor="#5594d0">
								<p align="center"><b><span class="style38">
								FIRSTATUS BOX</span></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp; </td>
							</tr>
							<tr>
								...
								<table width="719" height="107" border="0" align="center" id="table5">
									<tr>
...
int i=0;
							...
							ResultSet rs=st.executeQuery("Select * from firregister where custid='"+ss1+"'");
							...
							%>
									<tr>
									  <td height="40" bgcolor="#CADDFF">
										<font face="Verdana">&nbsp; 
										<input type="radio" name="sno1"  value=<%=frid2%> checked /></font></td>
										<td bgcolor="#CADDFF">
