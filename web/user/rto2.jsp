	...
	<TR>
		...
		<TD width="802" height="579">
			<table border="0" width="100%" id="table1" cellpadding="2" >
				...
				String z1=null;
				String z7=null;
				String x4=(String)session.getAttribute("vid1");
	 
				String qry="Select * from vehicleinfo where vehid="+x4;
...
if(rs91.next())
{
 ...
 if(z7.equals("NF"))
 {
 	%>	<tr>	<td><center><b>&nbsp;<% out.println("Sorry Your  Information Is Under Process....");
	}
  else
  {
  response.sendRedirect("rto1.jsp");
