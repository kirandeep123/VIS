...
<link rel="File-List" href="billall_files/filelist.xml">
...
absolute;z-index:1;left:540px;top:252px;width:201px;height:41px'><img
width=201 height=41 src="billall_files/image001.gif" v:shapes="_x0000_s1025"></span><![endif]><IMG SRC="images/workshop_04.gif" WIDTH=208 HEIGHT=550 usemap="#FPMap0" border="0"></TD>
		<TD width="778" rowspan="5">
			<div style="position: absolute; top: 308; left: 244; width: 654; height: 41">
              <table border="1" cellspacing="1" style="border-collapse: collapse" bordercolor="#800000" width="106%">
...
<%	
	...
	Connection cona=DriverManager.getConnection("jdbc:odbc:vis");
	String qry="select * from billregister";

	Statement sta=cona.createStatement(); 
	ResultSet rsa=null;
 
 
	rsa=sta.executeQuery(qry );
%>
                ...
                <tr>
                  ...
                  <td width="22%"><b>Mode Of Payement</b></td>
 	...
 	%>
                <tr>
                  <td width="10%">&nbsp;<% out.println(rsa.getInt(1));%></td>
                  <td width="13%">&nbsp;<% out.println(rsa.getDate(7));%></td>
                  <td width="9%">&nbsp;<% out.println(rsa.getString(2));%></td>
                  <td width="10%">&nbsp;<% out.println(rsa.getString(3));%></td>
                  <td width="22%">&nbsp;<% out.println(rsa.getString(4));%></td>
                  <td width="17%">&nbsp;<% out.println(rsa.getString(5));%></td>
                  <td width="75%">&nbsp;<% out.println(rsa.getString(6));%></td>
                </tr>
                <%  
 				} 
